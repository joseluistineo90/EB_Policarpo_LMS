				...
				<div class="span7">
						<form class="form-horizontal" method="post">
							<div class="control-group">
								<label class="control-label" for="inputEmail">Nuevo Password</label>
								<div class="controls">
								<input type="text" name="np" id="inputEmail" placeholder="Nuevo Password">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="inputPassword">Re-tipee Password</label>
								<div class="controls">
								<input type="password" name="rp" id="inputPassword" placeholder="Re-tipee Password">
								</div>
							</div>
							<div class="control-group">
								<div class="controls">
