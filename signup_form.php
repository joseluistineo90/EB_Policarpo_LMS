...
<form method="post" enctype="multipart/form-data">	
	...
	<div class="form-horizontal">
			...
			<label class="control-label" for="inputEmail">No es estudiante :</label>
			<div class="controls">
			<input type="text" id="inputEmail" name="student_no" value="<?php if (isset($_POST['submit'])){echo $student_no;} ?>" placeholder="No Student" required>
				&nbsp;	&nbsp; 	&nbsp; 	&nbsp;
	<?php if (isset($_POST['submit'])){?> 	<span class="label label-important"><?php echo $exist; ?></span><?php }?>
		...
		<div class="control-group">
			...
			<div class="control-group">
			<label class="control-label" for="inputPassword">Confirmar Password</label>
			<div class="controls">
			<input type="password" name="cpassword" value="<?php if (isset($_POST['submit'])){echo $cpassword;} ?>" placeholder="Confirmar Password" required>
		...
		<div class="control-group">
			<div class="controls">
			<button name="submit" type="submit" class="btn btn-info"><i class="icon-signin icon-large"></i>&nbsp;Confirmar</button>
			</div>
		</div>
    </div>
</div>
	...
	-->
		...
		<!--
		    ...
		    <div class="control-group">
    <label class="control-label" for="inputPassword">Ingrese el código de arriba</label>
    <div class="controls">
    <input id="code" name="code" type="text" placeholder="Ingrese el código de arriba" required></td>
