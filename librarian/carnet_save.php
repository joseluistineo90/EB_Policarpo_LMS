...
//insertamos los datos en la db
	mysql_query("insert into carnet(
		firstname_carnet,lastname_carnet,cedula_carnet,address_carnet,email_carnet,contact_carnet,ruta,ruta_miniatura) values ('$firstname_carnet','$lastname_carnet','$cedula_carnet','$address_carnet','$email_carnet','$contact_carnet','$destino','$destmini')")or die(mysql_error());
