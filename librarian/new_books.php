		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Tabla de Libros Nuevos</strong>
                                </div>
						<!--  -->
						...
						<h1>Libros Nuevos</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'nuevo'")or die(mysql_error());
                                    ...
                                    <td class="action">
                                        <a rel="tooltip"  title="Borar" id="<?php echo $id; ?>" href="#delete_book<?php echo $id; ?>" data-toggle="modal"    class="btn btn-danger"><i class="icon-trash icon-large"></i></a>
