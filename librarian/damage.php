		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Tabla de Libros DAÑADOS ->> (Ingrese aquí Libros con partes mutiladas, con "hongos" o humedad para su posible desincorporación e ingreso a la tabla "ARCHIVO" )<<--</strong>
                                </div>
						<!--  -->
								    <ul class="nav nav-pills">
										<li   class="active"><a href="books.php">All</a></li>
										<li><a href="new_books.php">Libros Nuevos</a></li>
										<li><a href="old_books.php">Excluir de Préstamos</a></li>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Categoría</th>
										<th>Autor</th>
										<th class="action">Volúmen / Nº págs</th>
										<th>COTA</th>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'deteriorado'")or die(mysql_error());
                                    ...
                                    <td class="action"><?php echo $row['book_copies']." /Págs: ".$row['pages']." p."; ?> </td>
