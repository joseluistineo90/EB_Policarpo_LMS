			...
			<div class="span12">	
						<!--  -->
								    <ul class="nav nav-pills">
										<li   class="active"><a href="archive.php">Archivo</a></li>
								...
								<a href="" onclick="window.print()" class="btn btn-info"><i class="icon-print icon-large"></i> Imprimir</a>
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;TABLA DE LIBROS (registros) DESINCORPORADOS DE LA BASE DE DATOS</strong>
                                </div>
						<!--  -->
						<center class="title">
