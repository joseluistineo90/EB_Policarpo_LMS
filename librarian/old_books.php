		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Tabla de Libro Antiguos ->>(La antiguedad según las normas de biblioteca o la que establezca el Bibliotecólogo)</strong>
                                </div>
						<!--  -->
