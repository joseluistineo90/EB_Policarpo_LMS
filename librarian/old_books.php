		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Tabla de Libros excluidos para préstamo circulante según las normas de biblioteca o la que establezca el Bibliotecólogo</strong>
                                </div>
						<!--  -->
						...
						<!--  -->
						<center class="title">
						<h1>Libros Antiguos o muy viejos</h1>
						</center>
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'antiguo'")or die(mysql_error());
