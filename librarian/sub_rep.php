		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Tabla de Libros en Restauración -> (Ingrese aquí sólo Libros para encuadernar o reparar)</strong>
                                </div>
						<!--  -->
						...
						<h1>Libros para Restaurar</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from book where status = 'para restaurar'")or die(mysql_error());
