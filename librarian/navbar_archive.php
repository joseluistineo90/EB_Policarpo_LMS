      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="active"><a href="archive.php"><i class="icon-list-alt icon-large"></i>&nbsp;Archivo</a></li>
					<li><a href="#myModal" data-toggle="modal"><i class="icon-search icon-large"></i>&nbsp;Búsqueda Avanzada</a></li>
